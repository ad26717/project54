...
import javafx.stage.Stage;
    ...
    public class CarDriver extends Application {
        ...
        public void start(Stage primaryStage) {
            ...
            input.setHeaderText("We are going to create your garage now!");
            input.setContentText("How many cars would you want to have in your garage?");
            input.showAndWait();
            int numCompare;
            ...
            for (int count = 1; count <= numCars; count++) {
                ...
                input.setHeaderText(" Colour");
                input.setContentText("Enter the colour for car " + count);
                input.showAndWait();
